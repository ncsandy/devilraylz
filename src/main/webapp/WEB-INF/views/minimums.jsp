                                    ...
                                    <div class="row">
                                        <div class="col-md-5 pr-md-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" disabled="" placeholder="Company" value="${user_account.pilotRank} ${user_account.fName} ${user_account.lName}">
                                            </div>
                                        </div>
                                        <div class="col-md-3 px-md-1">
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="text" class="form-control" disabled="" placeholder="Company" value="${user_account.email}">
                                            </div>
                                        </div>
                                        <div class="col-md-4 pl-md-1">
                                            <div class="form-group">
                                                <label>Birth Month</label>
                                                <input type="text" class="form-control" disabled="" placeholder="Company" value="${birthmonth}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 pr-md-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" disabled="" placeholder="Company" value="${currentstart}">
                                            </div>
                                        </div>
                                        <div class="col-md-6 pl-md-1">
                                            <div class="form-group">
                                                <label>Current Period End</label>
                                                <input type="text" class="form-control" disabled="" placeholder="Company" value="${currentend}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Current Semi-annual hours</label>
                                                <input type="text" class="form-control" disabled="" placeholder="Company" value="${semiannualhours} / 48.0">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 pr-md-1">
                                            <div class="form-group">
                                                <label>Flights flown in period</label>
                                                <input type="text" class="form-control" disabled="" placeholder="Company" value="${totalflights}">
                                            </div>
                                        </div>
                                    </div>
                                </form>
